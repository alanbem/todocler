 ...
 *
 * @see \Productivity\Infrastructure\Interfaces\Rest\ApiPlatform\Messenger\Middleware\RemoveTaskTransformingMiddlewareTest
 */
final class RemoveTaskTransformingMiddleware extends TransformingMiddleware
{
    public function handle(Envelope $envelope, StackInterface $stack) : Envelope
    {
        $resource = $envelope->getMessage();

        // input option does not work with DELETE method - esource object with proper stamp are used.
