 ...
 *
 * @see \Productivity\Domain\Event\ProjectCreatedTest
 */
final class ProjectCreated implements Domain\Event
{
    private const DATE_FORMAT = 'Y-m-d H:i:s.u P'; // microsecond precision
    private string $createdAt;

    public function __construct(private string $projectId, private string $name, private string $creatorId, \DateTimeImmutable $createdAt)
    {
