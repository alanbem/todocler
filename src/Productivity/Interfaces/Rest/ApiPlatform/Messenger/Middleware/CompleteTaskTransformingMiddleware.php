 ...
 *
 * @see \Productivity\Interfaces\Rest\ApiPlatform\Messenger\Middleware\CompleteTaskTransformingMiddlewareTest
 */
class CompleteTaskTransformingMiddleware extends TransformingMiddleware
{
