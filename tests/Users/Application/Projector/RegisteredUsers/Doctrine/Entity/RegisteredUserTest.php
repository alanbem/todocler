...
final class RegisteredUserTest extends TestCase
{
    ...
    {
        $user = new RegisteredUser('c4b6d1ee-f7f3-4a41-9cae-cae4e29403e6', 'alan.bem@example.com', 'password', $now = new \DateTimeImmutable());

        self::assertSame('c4b6d1ee-f7f3-4a41-9cae-cae4e29403e6', $user->getId());
        self::assertSame('alan.bem@example.com', $user->getEmail());
        self::assertSame('alan.bem@example.com', $user->getUserIdentifier());
