 ...
 *
 * @covers \Productivity\Infrastructure\Interfaces\Rest\ApiPlatform\Messenger\Middleware\RemoveProjectTransformingMiddleware
 * @covers \Productivity\Infrastructure\Interfaces\Rest\ApiPlatform\Messenger\Middleware\TransformingMiddleware
 */
final class RemoveProjectTransformingMiddlewareTest extends TestCase
{
    ...
    {
        $middleware = new RemoveProjectTransformingMiddleware();

        $message = new Entities\Project('62fafb74-f550-4780-a527-37cb0b1e08ae', 'name', '1a9d8b27-5896-4d50-b540-0d92b1708747', new \DateTimeImmutable(), new \DateTimeImmutable());
        ...
        $command = new Commands\RemoveProject('62fafb74-f550-4780-a527-37cb0b1e08ae', '6b244a62-0e1a-45ec-ac01-eb0f805432d9');
