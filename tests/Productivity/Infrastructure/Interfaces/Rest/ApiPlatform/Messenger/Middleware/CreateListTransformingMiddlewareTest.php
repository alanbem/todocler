 ...
 *
 * @covers \Productivity\Infrastructure\Interfaces\Rest\ApiPlatform\Messenger\Middleware\CreateListTransformingMiddleware
 * @covers \Productivity\Infrastructure\Interfaces\Rest\ApiPlatform\Messenger\Middleware\TransformingMiddleware
 */
final class CreateListTransformingMiddlewareTest extends TestCase
{
    ...
    {
        $middleware = new CreateListTransformingMiddleware();
