...
class TaskTest extends TestCase
{
    public function testTask()
    {
        ...
        $this->assertSame($list, $task->list());
        $this->assertSame('1d3db856-d874-4bc5-a41e-4268007bf6cd', $task->id());
        $this->assertSame('Task #1', $task->name());
        $this->assertSame('4cf1d6b1-4437-46a2-881f-3d6bc39b716c', $task->userId());
        $this->assertSame($updated, $task->updatedAt());
        $this->assertSame($created, $task->createdAt());
