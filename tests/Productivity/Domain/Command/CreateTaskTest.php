...
final class CreateTaskTest extends TestCase
{
    ...
    public function testCreatingTask() : void
    {
        $this
            ...
            ->when(
                new CreateTask('project-1', 'task-1', 'My first task', 'user-1'),
            )
            ->then(
    ...
    {
        $this->expectExceptionObject(new TaskAlreadyExists('project-1', 'task-1'));
    ...
    public function testCreatingTaskByWrongUser() : void
    {
        ...
        $this
            ...
            ->when(
                new CreateTask('project-1', 'task-1', 'My first task', 'user-2'),
            )
            ->then();
    }
    ...
    {
        $command = new CreateTask('project-1', 'task-1', 'My first task', 'user-1');
