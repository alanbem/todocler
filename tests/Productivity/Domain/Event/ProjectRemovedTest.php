 ...
 *
 * @covers \Productivity\Domain\Event\ProjectRemoved
 */
final class ProjectRemovedTest extends TestCase
{
    public function testEvent() : void
    {
        $event = new ProjectRemoved('project-1', 'user-1', $now = new \DateTimeImmutable());
